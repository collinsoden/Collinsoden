  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between h-16">
            ...
            >
              ...
              <div className="hidden sm:flex sm:flex-col sm:items-start sm:leading-none">
                ...
                <span
                  className={`${isDark ? "text-zinc-500" : "text-zinc-500"} text-[11px] tracking-[0.24em] uppercase`}
                >
                  Software Engineer
                </span>
              </div>
      ...
      >
        ...
        {/* Drawer */}
        <div
          className={`absolute top-16 left-4 right-4 rounded-2xl p-4 transition-all duration-300 ${
            mobileOpen
        ...
        >
          <div className="flex flex-col gap-1">
            ...
            <div
              className={`my-2 border-t ${isDark ? "border-white/10" : "border-black/10"}`}
            />
            <a
              href={personalInfo.resume}
              target="_blank"
