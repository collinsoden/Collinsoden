    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          {/* Vertical line */}
          <div
            className={`absolute left-6.75 md:left-1/2 top-0 bottom-0 w-px ${
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 shrink-0 md:absolute md:left-1/2 md:-translate-x-1/2 md:top-6">
                    <div
                      className={`w-14 h-14 rounded-2xl border-2 flex items-center justify-center shadow-xl transition-all duration-300 ${
                        isExpanded
                  ...
                  >
                    <button
                      ...
                      className={`w-full text-left glass rounded-2xl border p-6 transition-all duration-300 hover:scale-[1.01] ${
                        isExpanded
                          ? isDark
