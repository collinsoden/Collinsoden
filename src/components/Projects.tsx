...
function ProjectCard({
  ...
  return (
    ...
    >
      <div
        className={`relative h-full glass rounded-2xl border overflow-hidden transition-all duration-300 cursor-pointer group ${
          hovered
            ? isDark
      ...
      >
        ...
        {hovered && (
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(249,115,22,0.3) 0%, transparent 50%, rgba(245,158,11,0.2) 100%)",
              }}
            />
          </div>
        )}
        ...
        <div className="p-6">
          ...
          {/* Description */}
          <p
            className={`text-sm leading-relaxed mb-5 ${isDark ? "text-zinc-400" : "text-zinc-600"}`}
          >
            {project.description}
          </p>
          ...
          {/* View project link — falls back to the repo when there's no live URL */}
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        />
        <div
          className={`absolute bottom-0 left-1/4 w-72 h-72 rounded-full blur-3xl opacity-8 ${
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div
            className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-mono font-medium mb-4 border bg-orange-500/10 ${
              isDark
                ? "text-orange-300 border-orange-500/20"
                : "text-orange-700 border-orange-500/30"
            }`}
          >
            ◈ projects
          </div>
        ...
        {/* Filter tabs */}
        <div
          className={`flex flex-wrap gap-2 mb-10 p-1.5 rounded-xl w-fit mx-auto ${
        ...
        {/* CTA */}
        <div
          className={`text-center mt-16 fade-in-up ${visible ? "opacity-100" : "opacity-0"}`}
        >
          <p
            className={`text-sm mb-4 ${isDark ? "text-zinc-500" : "text-zinc-600"}`}
          >
            Want to see more?
          </p>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className={`inline-flex items-center gap-2 px-6 py-3 rounded-xl border font-medium text-sm transition-all duration-200 hover:scale-105 active:scale-95 ${
              isDark
